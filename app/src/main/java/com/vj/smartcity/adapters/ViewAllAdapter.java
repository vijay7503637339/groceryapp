package com.vj.smartcity.adapters;
...
//        holder.pMrp.setText(cc.getMrp());
       ...
       // Toast.makeText(context, ""+cc.getProductImage(), Toast.LENGTH_SHORT).show();
        Picasso.with(context)
                .load(BaseURL.IMG_URL2+cc.getProductImage()).networkPolicy(NetworkPolicy.NO_CACHE,NetworkPolicy.NO_STORE)
