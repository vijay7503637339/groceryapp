...
import com.vj.smartcity.modelclass.SubCatModel;
import com.vj.smartcity.util.CategoryFragmentClick;
...
import static com.vj.smartcity.config.BaseURL.IMG_URL2;
...
public class HomeCategoryAdapter extends RecyclerView.Adapter<HomeCategoryAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        Picasso.with(context)
                .load(IMG_URL2 + cc.getImages()).networkPolicy(NetworkPolicy.NO_CACHE,NetworkPolicy.NO_STORE)
