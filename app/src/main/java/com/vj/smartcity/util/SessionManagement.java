...
import com.vj.smartcity.activity.MainActivity;

import java.util.HashMap;
import java.util.Map;

import static com.vj.smartcity.config.BaseURL.APP_OTP_STATUS;
import static com.vj.smartcity.config.BaseURL.CART_ID_FINAL;
import static com.vj.smartcity.config.BaseURL.COUNTRY_CODE;
import static com.vj.smartcity.config.BaseURL.IS_LOGIN;
import static com.vj.smartcity.config.BaseURL.KEY_EMAIL;
import static com.vj.smartcity.config.BaseURL.KEY_HOUSE;
import static com.vj.smartcity.config.BaseURL.KEY_ID;
import static com.vj.smartcity.config.BaseURL.KEY_IMAGE;
import static com.vj.smartcity.config.BaseURL.KEY_MOBILE;
import static com.vj.smartcity.config.BaseURL.KEY_NAME;
import static com.vj.smartcity.config.BaseURL.KEY_PASSWORD;
import static com.vj.smartcity.config.BaseURL.KEY_PAYMENT_METHOD;
import static com.vj.smartcity.config.BaseURL.KEY_PINCODE;
import static com.vj.smartcity.config.BaseURL.KEY_REWARDS_POINTS;
import static com.vj.smartcity.config.BaseURL.KEY_SOCITY_ID;
import static com.vj.smartcity.config.BaseURL.KEY_SOCITY_NAME;
import static com.vj.smartcity.config.BaseURL.KEY_WALLET_AMMOUNT;
import static com.vj.smartcity.config.BaseURL.MAP_SELECTION;
import static com.vj.smartcity.config.BaseURL.PAYMENT_PAYPAL;
import static com.vj.smartcity.config.BaseURL.PAYMENT_PAYSTACK;
import static com.vj.smartcity.config.BaseURL.PAYMENT_RAZORPZY;
import static com.vj.smartcity.config.BaseURL.TOTAL_AMOUNT;
import static com.vj.smartcity.config.BaseURL.USER_CITY;
import static com.vj.smartcity.config.BaseURL.USER_CURRENCY;
import static com.vj.smartcity.config.BaseURL.USER_CURRENCY_CNTRY;
import static com.vj.smartcity.config.BaseURL.USER_EMAIL_SERVICE;
import static com.vj.smartcity.config.BaseURL.USER_INAPP_SERVICE;
import static com.vj.smartcity.config.BaseURL.USER_LANG;
import static com.vj.smartcity.config.BaseURL.USER_LAT;
import static com.vj.smartcity.config.BaseURL.USER_OTP;
import static com.vj.smartcity.config.BaseURL.USER_SKIP;
import static com.vj.smartcity.config.BaseURL.USER_SMS_SERVICE;
import static com.vj.smartcity.config.BaseURL.USER_STATUS;
import static com.vj.smartcity.config.BaseURL.USER_STOREID;
